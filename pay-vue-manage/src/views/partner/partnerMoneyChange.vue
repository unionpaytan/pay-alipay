  ...
  <div>
   ...
   <div class="flex flex-m tc topbox"> 
       ...
       <div class="flex-1 bor">
        ...
        <div class="num">{{parseFloat(countMap.sumMerchantRechargeAmt).toFixed(2) || 0.00}}</div>
      </div>

       <div class="flex-1 bor">
        <div>总代付手续费<span style="font-size:12px;">(USDT)</span></div>
   ...
   <div class="flex flex-m mr20">
    ...
    >
      ...
      <el-table-column class="w100" align="center" prop="flowType" label="类型" width="80">
        <template slot-scope="scope">
          <span :class="scope.row.flowType | flowTypeClass">{{scope.row.flowType | flowType }}</span>
        </template>
      </el-table-column>  
      
      <el-table-column align="center" prop="amt" label="变动金额" width="109"></el-table-column>

      <el-table-column align="center" prop="amtBefore" label="账变前" width="89"></el-table-column>
      <el-table-column align="center" prop="amtNow" label="账变后余额" width="109"></el-table-column>
...
export default {
  ...
  data() {
    return {
      ...
      countMap: {
          ...
          sumMerchantDepositAmt:0,
          sumMerchantRechargeAmt:0,
      },
  ...
  methods: {
    ...
    getDatalist() {
      ...
      this.m_api
        .queryPartnerMoneyChangePage(data)
        .then(res => {
          //console.log(res)
