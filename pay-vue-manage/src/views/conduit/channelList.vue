...
<template>
 ...
 <el-table-column align="center" prop="productName" label="支付产品名称" width="170"></el-table-column>
  <el-table-column align="center" prop="productCode" label="支付产品编号" width="170"></el-table-column>
      <el-table-column align="center" prop label="通道名称/编号" width="170">
         <template slot-scope="scope">{{scope.row.channelName }}<br>{{scope.row.channelCode }}</template>
      </el-table-column>
      ...
      <el-table-column align="center" prop="singleCost" label="代收单笔成本">
    ...
    >
      <el-form :model="formData" :rules="m_rules" ref="ruleForm" label-width="120px">
        ...
        <div class="flex flex-m">
          <el-form-item class="flex-1" label="代收时间">
            <el-time-picker
              class="w200"
        ...
        <div class="flex flex-m">
          <el-form-item class="flex-1" label="代收单笔成本" prop="singleCost">
            <el-input
              class="w200"
              type="number"
              @mousewheel.native.prevent
